    ...
    p.accordeon(
        ...
        [
            ...
            {'title': 'Wat jij zelf doet — en waarom',
             'body': '<p>Drie momenten blijven van jou. Je maakt je eigen accounts '
                     'aan, en je voltooit de twee inlogstappen: <code>gh auth '
                     'login</code> voor GitHub en <code>firebase login</code> voor '
                     'Firebase.</p>'
