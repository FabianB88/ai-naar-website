...
def bouw(p):
    ...
    p.tekst(
        ...
        '<p>Het eindresultaat staat online. Klik erdoorheen voordat je begint: dan '
        'weet je waar je naartoe werkt, en zie je dat dit meer is dan een pagina met '
        'een formulier eronder. Er zit een menu in, een overzicht van vijf producten '
        'met zoeken en filteren, een paspoort per product, en een beheerkant waar de '
        'meldingen binnenkomen.</p>'
        '<p>Doe de rondgang: open een product, meld de staat, en kijk daarna bij '
        '<i>Meldingen</i>. Je ziet je eigen melding staan, de teller in het menu '
        'loopt op, en in het overzicht is de staat van dat product meteen '
        'veranderd.</p>'
        '<p>Let op waar die melding blijft: in het voorbeeld in je eigen browser, in '
        'jouw versie in de database. Dat is precies het verschil dat hoofdstuk 7 '
        'maakt, en het is één regel code.</p>'
